...
function showLocation2(str,province_id,city_id,county_id) {
    if(!province_id)province_id="loc_province2";
    if(!city_id)city_id="loc_city2";
    if(!county_id)county_id="loc_county2";
    province=city=county='';
    if(str){
        l=str.split(',');
        province=parseInt(l[0]);
