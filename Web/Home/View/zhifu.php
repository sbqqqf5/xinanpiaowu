...
<head>
    ...
    <link rel="stylesheet" href="/Public/home_pc/css/zhifu.css">
</head>
<body>
<div class="header">
    ...
    <div class="planBox cl">
        <div class="plan z">
            <div class="planText z">
                1、提交订单
            </div>
            <img src="/Public/home_pc/images/shoppingCart_arrow_red.png" class="z" alt="">
        </div>
        <div class="plan z">
            <div class="planText z planOk">
                2、微信支付
            </div>
            <img src="/Public/home_pc/images/shoppingCart_arrow_gray.png" class="z" alt="">
        </div>
        <div class="plan z">
            <div class="planText z">
                3、发货员为你发货
    ...
    <div class="content cl wp">
        <div class="main cl">
            <div class="mainZ z">
                <div class="money">
                    1666元
                </div>
                <div class="goodsAll cl">
                    <div class="z ellipse">【张惠妹乌托邦周边】UTOPIA 发光棒（附赠UTOPIA面具一个）</div>
                    <div class="z ellipse">【张惠妹乌托邦周边】UTOPIA 发光棒（附赠UTOPIA面具一个）</div>
                    <div class="z ellipse">【张惠妹乌托邦周边张惠妹乌托邦周边】UTOPIA 发光棒（附赠UTOPIA面具一个）</div>
...
<script src="/Public/home_pc/js/location.js"></script>
<script>
