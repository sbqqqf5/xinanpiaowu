...
<div id="page-wrapper">
    <div id="page-inner">
        ...
        <form action="<?=U('ticketEdit') ?>" method="POST" role="form" class="form-horizontal">
            <legend>修改门票</legend>
        
            <div class="form-group">
                <label for="title" class="col-sm-2 control-label">标题</label>
                <div class="col-sm-10">
                    <input type="text" name="title" id="title" class="form-control" required="required" value="<?=$detail['title'] ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 checkbox">
                    <label>
                        <input type="checkbox" name="is_order" id="is_order" value="1" <?=$detail['is_order']?'checked':'' ?>>
                        预订
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10 checkbox">
                    <label>
                        <input type="checkbox" name="is_home" id="is_home" value="1" <?=$detail['is_home']?'checked':'' ?>>
                        显示
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" name="sorted" id="inputSorted" class="form-control" required placeholder="值越大，排列越前" value="<?=$detail['sorted'] ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input type="number" name="deposit" id="deposit" class="form-control" value="<?=$detail['deposit'] ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input type="number" name="distribute_price" id="distribute_price" class="form-control" value="<?=$detail['distribute_price'] ?>">
                        <div class="input-group-addon">&yen;</div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="venues" id="venues" class="form-control" required value="<?=$detail['venues'] ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    ...
                    <?php foreach($columns as $column): ?>
                        <option value="<?=$column['id'] ?>" <?=$detail['columns']==$column['id']?'selected':'' ?>><?=$column['name'] ?></option>
                    <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    ...
                    <?php foreach($cities as $city): ?>
                        <option value="<?=$city['id'] ?>" <?=$detail['city']==$city['id']?'selected':'' ?>><?=$city['name'] ?></option>
                    <?php endforeach; ?>
                    </select>
                </div>
            </div>
                ...
                <div class="col-sm-2">
                    <select name="cate" id="inputCate" class="form-control" required="required">
                        <?php foreach ($cates as $cate): ?>
                            <option value="<?=$cate['id'] ?>" <?=$detail['cate']==$cate['id']?'selected':'' ?>><?=$cate['name'] ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <input type="text" name="view_location[]" class="form-control" required value="<?=$detail['view_location'][0] ?>">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="input-group">
                            <div class="input-group-addon">价格</div>
                            <input type="number" name="price[]" class="form-control" required value="<?=$detail['price'][0] ?>">
                            <div class="input-group-addon">&yen;</div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <input type="number" name="vip_price[]" class="form-control" required value="<?=$detail['vip_price'][0] ?>">
                            <div class="input-group-addon">&yen;</div>
                        </div>
                    </div>
                </div>
                ...
                <!-- 价格  添加块 -->
                <?php for($i=1;$i<count($detail['view_location']) ; $i++): ?>
                <label  class="col-sm-2"></label>
                <div class="form-group">
                    <div class="col-sm-3">
                        <div class="input-group">
                            <div class="input-group-addon">位置</div>
                            <input type="text" name="view_location[]" class="form-control" required value="<?=$detail['view_location'][$i] ?>">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="input-group">
                            <div class="input-group-addon">价格</div>
                            <input type="number" name="price[]" class="form-control" required value="<?=$detail['price'][$i] ?>">
                            <div class="input-group-addon">&yen;</div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="input-group">
                            <div class="input-group-addon">会员价</div>
                            <input type="number" name="vip_price[]" class="form-control" required value="<?=$detail['vip_price'][$i] ?>">
                            <div class="input-group-addon">&yen;</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group date datetimepicker col-sm-3" data-date-format="yyyy-mm-dd hh:ii" data-link-field="time-1" >
                    <input class="form-control" size="16" type="text" value="<?=$detail['performance_time'][0] ?>" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
                <input type="hidden" id="time-1" name="performance_time[]" value="<?=$detail['performance_time'][0] ?>">

                <?php foreach($detail['performance_time'] as $key=>$v):if($key==0){continue;} ?>
                    <div class="input-group date datetimepicker col-sm-offset-2 col-sm-3" data-date-format="yyyy-mm-dd hh:ii" data-link-field="time-<?=$key+2 ?>">
                        <input class="form-control" size="16" type="text" value="<?=$v ?>" readonly>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                    </div>
                    <input type="hidden" id="time-<?=$key+2 ?>" name="performance_time[]" value="<?=$v ?>">
                <?php endforeach; ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="inventory" id="inventory" class="form-control" required value="<?=$detail['inventory'] ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input type="text" name="performance_duration" id="performance_duration" class="form-control" value="<?=$detail['performance_duration'] ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="entry_time" id="entry_time" class="form-control" required value="<?=$detail['entry_time'] ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="limit_explain" class="col-sm-2 control-label">限购说明</label>
                <div class="col-sm-10">
                    <input type="text" name="limit_explain" id="limit_explain" class="form-control" required value="<?=$detail['limit_explain'] ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="child_explain" class="col-sm-2 control-label">儿童入场说明</label>
                <div class="col-sm-10">
                    <input type="text" name="child_explain" id="child_explain" class="form-control" required value="<?=$detail['child_explain'] ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="should_known" id="should_known" class="form-control" rows="8" required="required"><?=$detail['should_known'] ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="input" class="col-sm-2 control-label">原首页缩略图</label>
                <div class="col-sm-10">
                    <img src="<?=$detail['home_thumb'] ?>" alt="图片不存在" class="img-rounded" width="200">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="hidden" name="home_thumb" value="<?=$detail['home_thumb'] ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="input" class="col-sm-2 control-label">原列表缩略图</label>
                <div class="col-sm-10">
                    <img src="<?=$detail['thumb'] ?>" alt="图片不存在" class="img-rounded" width="200">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="detail" id="detail" style="height:400px"><?=$detail['detail'] ?></textarea>
                </div>
            </div>
...
/* datetimepick init */
    ...
    var time_block_count = <?=count($detail['performance_time']) ?>;
    /* 开始时间 添加输入块 */
    function time_block_add(obj)
    {
        ...
        // $('.datetimepick,.dropdown-menu').remove();
        datatimepicker_init();
    }
    /* 开始时间 删除输入块 */
    function time_block_delete(obj)
    {
        ...
        $(obj).parent().prev().remove();
        $('.datetimepick.dropdown-menu:last').remove();
    }

    /* 添加 价格输入组 */
    var price_block_count = <?=count($detail['view_location']) ?>;
