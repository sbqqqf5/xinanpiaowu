...
<head>
    ...
    <style type="text/css">
        ...
        table>tbody>tr>td{vertical-align: middle !important ;font-size:14px;}
            ...
            <?php foreach($data as $k=>$v): ?>
                <tr>
                    ...
                    <td class="text-center td-manage">
                        <a href="<?=U('view',['id'=>$v['id'], 'action'=>'end']) ?>">
                        ...
                        <a href="javascript:;" onclick="item_delete(this, <?=$v['id'] ?>)">
                            <span class="glyphicon glyphicon-trash" aria-hidden="true" title="删除" data-toggle="toggle" data-placement="bottom"></span>
                        </a>
                    </td>
                </tr>
            <?php endforeach; ?>
